...
function App() {
	...
	const behaviorType = {
		...
		"S" : [
			...
			"안정성(Steadiness)을 강점으로 지닌 사람들은 신중하며 계획적인 행동 경향을 보입니다. 예상하지 않은 돌발상황이 발생하는 것을 좋아하지 않기 때문입니다. 거의 존재하는 모든 상황이 닥치는 순간 머리 속으로 계획을 구상하기 시작하며, 심지어 의사소통 상황에서 조차 어떤 말을 하기 위해 과정을 빌드업하곤 합니다. 갑작스러운 논쟁 상황에서 말을 잘 하는 편이 아닙니다. 되려 논쟁이 끝난 뒤에야 어떻게 말을 했어야 했는지 상상하며 자책하는 편입니다.",
		...
		"결과지향자" : [
			...
			"결과지향자는 타인에게 무신경하다는 인상을 남깁니다. 업무를 상의 없이 독자적으로 처리하며, 타인의 조언을 한 귀로 흘릴 때가 종종 있기 때문입니다. 하지만 타인의 진심어린 충고를 들을 때면 굉장히 고마워하곤 합니다. 패션, 광고, 뷰티, 크리에이터와 같은 이미지를 가지고 있습니다."
		],
		...
		"헌신자" : [
			...
			"헌신자는 사교형(Influence)의 강점에 정적인 상황을 선호하는 사고가 더해진 성향을 가집니다. 따라서 희생이 요구되는 상황에 쳐했을 때, 해당 상황에서 서로의 눈치를 보며 불안함을 느끼고 스트레스를 받는 상황을 피하고자 본인이 피해를 자처하는 행동 경향을 보입니다.", 
		...
		"디자이너" : [
			...
			"디자이너는 DISC의 12가지 패턴 중 가장 흔치 않은 패턴입니다. 안정적인 상황을 추구하는 성향과 목표를 달성하고자 하는 진취적인 성향이 공존하기 때문입니다. 때문에 두 성향 사이에서 늘 선택을 고민하며, 매번 선택이 달라 '나도 나를 모르겠어요' 와 같은 말을 종종 하곤 합니다.", 
